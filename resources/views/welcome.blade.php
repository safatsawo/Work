...
@section('content')
 			...
 			<div class="row no-gutters">
 				...
 				<div class="col-md-3 d-flex services align-self-stretch p-4 ftco-animate">
 					<div class="media block-6 d-block text-center">
 						...
 						<div class="media-body p-2 mt-3">
 							<h3 class="heading">Clinical Services</h3>
 							<p>Even the all-powerful Pointing has no control about the blind texts it is an almost
 								unorthographic.</p>
 						</div>
 					</div>
 				...
 				<div class="col-md-3 d-flex services align-self-stretch p-4 ftco-animate">
 					<div class="media block-6 d-block text-center">
 						...
 						<div class="media-body p-2 mt-3">
 							<h3 class="heading">Kiddie EyeCare Day</h3>
 							<p>Even the all-powerful Pointing has no control about the blind texts it is an almost
 								unorthographic.</p>
 						</div>
 					</div>
 				...
 				<div class="col-md-3 d-flex services align-self-stretch p-4 ftco-animate">
 					<div class="media block-6 d-block text-center">
 						...
 						<div class="media-body p-2 mt-3">
 							<h3 class="heading">Corporate Social Resp.</h3>
 							<p>Even the all-powerful Pointing has no control about the blind texts it is an almost
 								unorthographic.</p>
 						</div>
 					</div>
 		...
 		<div class="container">
 			<div class="row no-gutters">
 				<div class="col-md-5 p-md-5 img img-2 mt-5 mt-md-0"
 					style="background-image: url(images/doc5.jpeg);">
 				</div>
 				<div class="col-md-7 wrap-about py-4 py-md-5 ftco-animate">
 					<div class="heading-section mb-5">
 						<div class="pl-md-5 ml-md-5">
 							<span class="subheading">About ThirdEye Care </span>
 							<h2 class="mb-4" style="font-size: 28px;">Medical specialty concerned with the eye of
 								people.</h2>
 						</div>
 					</div>
 						...
 						<div class="row mt-5 pt-2">
 							<div class="col-lg-6">
 								<div class="services-2 d-flex">
 									...
 									<div class="text">
 										<h3>Choose from a variety of frames</h3>
 										<p>Third Eyecare and Vision Centre delivers your products straight to you
 											anyway in Ghana! We save you time!.</p>
 									</div>
 								</div>
 							</div>
 							<div class="col-lg-6">
 								<div class="services-2 d-flex">
 									...
 									<div class="text">
 										...
 										<p>And in addition, we have best team to offer you professional services right
 											from the front desk to optometrist. Our equipment can be purchased through
 											our partner Pekonmed</p>
 									</div>
 								</div>
 							</div>
 	...
 	<section class="ftco-intro" style="background-image: url(images/bg_3.jpg);"
 		...
 		<div class="container">
 			<div class="row">
 				<div class="col-md-9">
 					<h2>We Provide EyeCare Care Consultation</h2>
 					<p class="mb-0">Your Eye is Our Top Priority with Comprehensive, Affordable medical.</p>
 					<p></p>
 				</div>
 				<div class="col-md-3 d-flex align-items-center">
 					<p class="mb-0"><a href="/appointment" class="btn btn-secondary px-4 py-3">Book Consutation</a></p>
 				</div>
 			</div>
 		</div>
 	</section>
 				...
 				<div class="row">
 					<div class="col-md-12 nav-link-wrap">
 						<div class="nav nav-pills d-flex text-center" id="v-pills-tab" role="tablist" aria-orientation="vertical">
 							<a class="nav-link ftco-animate active" id="v-pills-1-tab" data-toggle="pill" role="tab" aria-controls="v-pills-1" aria-selected="true">Comprehensive eye examinations</a>

 							<a class="nav-link ftco-animate" id="v-pills-2-tab" data-toggle="pill" role="tab" aria-controls="v-pills-2" aria-selected="false">Contact lenses</a>

 							<a class="nav-link ftco-animate" id="v-pills-3-tab" data-toggle="pill" role="tab" aria-controls="v-pills-3" aria-selected="false">Ocular pathology
 							</a>

 							<a class="nav-link ftco-animate" id="v-pills-4-tab" data-toggle="pill" role="tab" aria-controls="v-pills-4" aria-selected="false">Geriatric optometry
 							</a>

 							<a class="nav-link ftco-animate" id="v-pills-5-tab" data-toggle="pill" role="tab" aria-controls="v-pills-5" aria-selected="false">Paediatric optometry
 							</a>
 							<a class="nav-link ftco-animate" id="v-pills-5-tab" data-toggle="pill" role="tab" aria-controls="v-pills-5" aria-selected="false">Low vision
 							</a>
 							<a class="nav-link ftco-animate" id="v-pills-5-tab" data-toggle="pill" role="tab" aria-controls="v-pills-5" aria-selected="false">Binocular vision
 							</a>
 							<a class="nav-link ftco-animate" id="v-pills-5-tab" data-toggle="pill" role="tab" aria-controls="v-pills-5" aria-selected="false">Corporate medical screenings
 							</a>
 							<a class="nav-link ftco-animate" id="v-pills-5-tab" data-toggle="pill" role="tab" aria-controls="v-pills-5" aria-selected="false">School eye examinations
 							</a>
 							<a class="nav-link ftco-animate" id="v-pills-5-tab" data-toggle="pill" role="tab" aria-controls="v-pills-5" aria-selected="false">Community-based eye
 								screening services
